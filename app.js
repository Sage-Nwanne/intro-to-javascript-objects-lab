...
for (let partyIdx = 0; partyIdx < game.party.length; partyIdx++) {
  ...
  console.log('Exercise 8', pokemonInParty);
}
...
pokemon.forEach(pokemon => {
  if (pokemon.starter === true) {
    console.log('Exercise 9',[pokemon.name]);
  }
});
...
let pokemonToCatch = { name: "Pikachu", type: "Electric" };

game.catchPokemon(pokemonToCatch)

console.log( 'excercise 10', game.party)
